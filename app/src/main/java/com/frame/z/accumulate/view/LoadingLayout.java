...
import com.frame.z.accumulate.util.OtherUtil;
import com.frame.z.accumulate.util.SystemUtil;
...
public class LoadingLayout extends FrameLayout {
    ...
    public LoadingLayout(Context context, AttributeSet attrs) {
        ...
        pageBackground = a.getColor(R.styleable.LoadingLayout_pageBackground, SystemUtil.getColor(mContext, R.color
    ...
    private void build() {
        ...
        errorText = SystemUtil.findViewById(errorPage, R.id.error_text);
        emptyText = SystemUtil.findViewById(emptyPage, R.id.empty_text);
        networkText = SystemUtil.findViewById(networkPage, R.id.no_network_text);

        errorImg = SystemUtil.findViewById(errorPage, R.id.error_img);
        emptyImg = SystemUtil.findViewById(emptyPage, R.id.empty_img);
        networkImg = SystemUtil.findViewById(networkPage, R.id.no_network_img);

        errorReloadBtn = SystemUtil.findViewById(errorPage, R.id.error_reload_btn);
        networkReloadBtn = SystemUtil.findViewById(networkPage, R.id.no_network_reload_btn);
        ...
        errorText.setTextColor(SystemUtil.getColor(mContext, mConfig.tipTextColor));
        emptyText.setTextColor(SystemUtil.getColor(mContext, mConfig.tipTextColor));
        networkText.setTextColor(SystemUtil.getColor(mContext, mConfig.tipTextColor));
        ...
        errorReloadBtn.setTextColor(SystemUtil.getColor(mContext, mConfig.buttonTextColor));
        networkReloadBtn.setTextColor(SystemUtil.getColor(mContext, mConfig.buttonTextColor));

        if (mConfig.buttonHeight != -1) {

            errorReloadBtn.setHeight(SystemUtil.dp2px(mContext, mConfig.buttonHeight));
            networkReloadBtn.setHeight(SystemUtil.dp2px(mContext, mConfig.buttonHeight));
        }
        if (mConfig.buttonWidth != -1) {

            errorReloadBtn.setWidth(SystemUtil.dp2px(mContext, mConfig.buttonWidth));
            networkReloadBtn.setWidth(SystemUtil.dp2px(mContext, mConfig.buttonWidth));
        }
    ...
    public LoadingLayout setReloadButtonTextColor(@ColorRes int id) {
        ...
        errorReloadBtn.setTextColor(SystemUtil.getColor(mContext, id));
        networkReloadBtn.setTextSize(SystemUtil.getColor(mContext, id));
        return this;
    }
    ...
    public LoadingLayout setDefineBackgroundColor(@ColorRes int color) {
        ...
        if (defineLoadingPage == null) {
            loadingPage.setBackgroundColor(SystemUtil.getColor(mContext, color));
        } else {
            defineLoadingPage.setBackgroundColor(SystemUtil.getColor(mContext, color));
        }
        errorPage.setBackgroundColor(SystemUtil.getColor(mContext, color));
        emptyPage.setBackgroundColor(SystemUtil.getColor(mContext, color));
        networkPage.setBackgroundColor(SystemUtil.getColor(mContext, color));
        return this;
    }
